...
class SchedulerNode(Node):
    ...
    def __init__(self) -> None:
        ...
        # DUAL_PICK_MULTI_DROP: (first_pick, second_pick) weights - 왕복 작업
        ...
        self.chargers = [
            ChargerSpec(charger_id=1, x=0.0, y=-6.0),
            ChargerSpec(charger_id=2, x=0.0, y=4.0),
        ]
