...
class SchedulerNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.optimization_epoch = self.declare_parameter("optimization_epoch", 10).get_parameter_value().integer_value
        self.optimization_pop_size = self.declare_parameter("optimization_pop_size", 10).get_parameter_value().integer_value
