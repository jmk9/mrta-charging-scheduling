...
def make_6_timelines_figure(
    ...
    # legend 위치를 더 아래로 내려서 xlabel과 겹치지 않게 조정
    fig.legend(
        ...
        loc="lower center",
        bbox_to_anchor=(0.5, -0.02),  # 기존 0.01에서 더 아래로
        ncol=6,
        frameon=False,
        fontsize=22,
        handlelength=2.2,
...
if __name__ == "__main__":
    ...
    cases.append({
        "algo_name": "Threshold",
        "robot_sequences": {
            "tb1": [43, 10, 27, 42, "c2", 46, 4, 1, "c2", 22, 26, 31, "c1", 47, 37],
            "tb2": [16, 21, 15, 12, 41, 49, 35, "c2", 29, 17, 48, 30, 13, 6],
            "tb3": [34, 25, 11, 3, 9, "c1", 24, 28, 19, 32, "c1", 8, 2, 18, 40],
            "tb4": [23, 38, 50, 33, 36, 45, "c1", 39, 14, 5, 20, 44, 7],
        },
        "target_makespan": {
            "tb1": 1826.93,
            "tb2": 1258.40,
    ...
    # Feasibility
    cases.append({
        "algo_name": "Feasibility",
        "robot_sequences": {
            "tb1": [43, 10, 27, 42, 46, 4, "c1", 1, 22, 26, 31, "c1", 47, 37],
            "tb2": [16, 21, 15, 12, 41, 49, 35, "c2", 29, 17, 48, 30, 13, 6],
            "tb3": [34, 25, 11, 3, 9, "c1", 24, 28, 19, 32, "c1", 8, 2, 18, 40],
            "tb4": [23, 38, 50, 33, 36, 45, "c2", 39, 14, 5, 20, 44, 7],
        },
        "target_makespan": {
            "tb1": 1749.67,
            "tb2": 1258.40,
    ...
    # 모든 로봇 scale을 1.379986로 통일
    fixed_scale = 1.379986
    for case in cases:
        robots = case["robot_sequences"].keys()
        case["override_scales"] = {r: fixed_scale for r in robots}

    make_6_timelines_figure(tasks, cases, save_path="timeline_policy.png")
