...
class SchedulerNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.get_logger().info(
            ...
            f"task allocation: running GA, MPA, HHO and selecting best by makespan (epoch={self.optimization_epoch}, pop_size={self.optimization_pop_size})"
        )
        ...
        for rid in self.robot_ids:
            ...
            for task in seq:
                ...
                if soc < required:
                    ...
                    if charger is None:
                        # No charger defined 	o cannot make this sequence feasible.
